    ...
    const productos = [
        {
            ...
            precio: 68000,
            imagenes: ["img/buzo1.jpg", "img/buzo2.jpg", "img/buzo3.jpg"]
        },
        {
            nombre: "Chomba Deportiva",
            precio: 48000,
            imagenes: ["img/chomba1.jpg", "img/chomba2.jpg", "img/chomba3.jpg"]
        },
        {
            nombre: "Medias Antideslizantes",
            precio: 20000,
            imagenes: ["img/medias1.jpg", "img/medias2.jpg", "img/medias3.jpg"]
        },
        {
            nombre: "Conjunto de Entrenamiento",
            precio: 58000,
            imagenes: ["img/conjunto1.jpg", "img/conjunto2.jpg"]
        },
        {
    ...
    productos.forEach(producto => {
        ...
        card.innerHTML = `
            ...
            <a
                class="whatsapp"
                target="_blank"
                href="https://wa.me/5492962433128?text=Hola me interesa el producto ${producto.nombre}">
